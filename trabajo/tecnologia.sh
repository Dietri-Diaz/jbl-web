#!/usr/bin/env bash
# ==========================================================================
#  PROYECTO JBL  -  aporte de CUARTO INTEGRANTE
...
echo ""
echo "=================================================================="
echo "   Aporte de CUARTO INTEGRANTE  ->  $RAMA"
echo "=================================================================="
echo ""
...
# ---- Tus commits -----------------------------------------------------------
echo "--> Bloques de tecnologia, cierre y pie de pagina"
...
.pie {
  max-width: var(--ancho);
  margin-inline: auto;
  padding: var(--e-2xl) var(--margen) var(--e-3xl);
  display: flex;
  flex-direction: column;
  gap: var(--e-lg);
  border-top: 1px solid var(--borde);
...
.pie__enlaces a { transition: color var(--rapido) var(--curva); }
...
<main id="contenido">
  ...
  <section class="tecnologia" id="tecnologia">
    <header class="seccion__cabeza">
      <p class="etiqueta reveal">03 — La tecnología</p>
      <h2 class="titulo reveal">Lo que hay dentro</h2>
    </header>

    <div class="bento">
      <article class="bloque bloque--ancho reveal">
        <svg class="bloque__ico" aria-hidden="true"><use href="#ico-sonido"/></svg>
        <h3>JBL Pro Sound</h3>
        <p>
          La misma firma sonora que se usa en estudios de grabación y estadios,
          calibrada para un equipo que cabe en una mochila. Graves profundos sin
          ensuciar la voz.
        </p>
      </article>

      <article class="bloque reveal">
        <svg class="bloque__ico" aria-hidden="true"><use href="#ico-agua"/></svg>
        <h3>Resistencia IP67</h3>
        <p>Polvo y agua fuera. Sumergible hasta 1 metro durante 30 minutos.</p>
      </article>

      <article class="bloque reveal">
        <svg class="bloque__ico" aria-hidden="true"><use href="#ico-bateria"/></svg>
        <h3>Hasta 24 horas</h3>
        <p>Batería que aguanta el viaje de ida, la fiesta y el regreso.</p>
      </article>

      <article class="bloque bloque--ancho reveal">
        <svg class="bloque__ico" aria-hidden="true"><use href="#ico-enlace"/></svg>
        <h3>PartyBoost</h3>
        <p>
          Conecta varios parlantes compatibles y conviértelos en un solo sistema.
          Más equipos, más presión sonora, un mismo compás.
        </p>
      </article>
    </div>
  </section>
  ...
  <section class="cierre" id="contacto">
    <p class="etiqueta reveal">04 — Súbele</p>
    <h2 class="cierre__titulo reveal">
      El silencio<br>está sobrevalorado
    </h2>
    <p class="cierre__texto reveal">
      Encuentra el parlante que te acompaña en tiendas autorizadas JBL
      de todo el país.
    </p>
    <a class="boton boton--solido boton--grande reveal" href="#productos">
...
<footer class="pie">
  <div class="pie__caja">
    ...
    <nav class="pie__enlaces" aria-label="Navegación del pie">
      <a href="#manifiesto">Marca</a>
      <a href="#productos">Parlantes</a>
      <a href="#tecnologia">Tecnología</a>
    </nav>
  ...
  <p class="pie__aviso">
    Proyecto académico sin fines comerciales. Sitio no oficial.
    JBL es una marca registrada de Harman International Industries.
  </p>
</footer>
...
git commit -m 'feat: agrega los bloques de tecnologia, el cierre y el pie'
echo ""
